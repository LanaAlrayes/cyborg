    ...
    return (
        <div className='section-wrapper'>
            ...
            <div className='most-popular-items'>
                ...
                <Card image={popular_05} title="MiniCraft" category="Sandbox" rate="3.8" download="2.3M" />
                <Card image={popular_06} title="Eagles Fly" category="Matrix Games" rate="4.8" download="1.1M" />
                <Card image={popular_07} title="Warface" category="Max 3D" rate="2.7" download="5.3M" />
                <Card image={popular_08} title="Warcraft" category="Legend" rate="3.9" download="6.1M" />
